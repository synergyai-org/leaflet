  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 md:gap-6">
        <a href={logos.leftLink || '#'} target="_blank" rel="noopener noreferrer" className="h-7 md:h-8 opacity-90 transition-all hover:opacity-100 block">
          <img 
      ...
      <div className="h-5 md:h-6 flex items-center">
        {logos.rightLink ? (
          <a href={logos.rightLink} target="_blank" rel="noopener noreferrer" className="h-full opacity-80 transition-all hover:opacity-100 block">
             <img 
          ...
          <div className="h-full opacity-80 transition-all hover:opacity-100">
            <img 
              src={getDirectImageUrl(logos.rightLogo)} 
              alt="Right Logo" 
              className={`h-full w-auto object-contain ${filterClass}`} 
